...
import { deltaForcePacks, deltaForceSpecialOffers, deltaForcePaymentMethods } from '@/lib/data';
...
export function DeltaForceContent() {
    ...
    const [playerName, setPlayerName] = useState('PlayerName'); // Placeholder
                    ...
                    {/* Payment Method Section */}
                     <div>
                      ...
                      <div className="grid grid-cols-2 gap-2.5 md:grid-cols-3 md:gap-4">
                        {deltaForcePaymentMethods.map((method) => (

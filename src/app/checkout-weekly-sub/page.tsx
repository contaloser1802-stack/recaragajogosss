...
function CheckoutForm() {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
    ...
    const checkoutData: CheckoutData = {
        ...
        bonusAmount: '300',
        totalAmount: '1.300',
        productDescription: "Recarga Free Fire - Assinatura Semanal",
    };
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      const response = await fetch("https://9000-firebase-recargajogo-1751248654783.cluster-m7tpz3bmgjgoqrktlvd4ykrc2m.cloudworkstations.dev/api/create-payment", {
        method: "POST",

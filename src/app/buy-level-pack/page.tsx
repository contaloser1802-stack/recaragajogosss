...
const BuyLevelPackPage = () => {
  ...
  const checkoutData: CheckoutData = {
    playerName,
    price: '7480',
    formattedPrice: 'R$ 74,80',
    paymentMethodName: 'PagSeguro',
    originalAmount: '7.800',
    bonusAmount: '5.600',
    totalAmount: '13.400',
    productDescription: "Recarga Free Fire - Pacote de Diamantes",
  };
...
export default BuyLevelPackPage;
